<template>
  ...
  <div class="modal fade" id="createEvent" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <form class="text-dark">
          <div class="mb-3">
           ...
           <div class="mb-3">
            ...
            <input v-model="editable.coverImg" type="text" class="form-control" id="coverImg" aria-describedby="emailHelp">
           </div>
          <div class="mb-3">
            <label for="location" class="form-label">location of event</label>
            <input v-model="editable.location" type="text" class="form-control" id="location" aria-describedby="emailHelp">
           </div>
          <div class="mb-3">
            <label for="capacity" class="form-label">capacity of event</label>
            <input v-model="editable.capacity" type="number" class="form-control" id="capacity" aria-describedby="emailHelp">
          </div>
          <div class="mb-3">
            <label for="startDate" class="form-label">startDate of event</label>
            <input v-model="editable.startDate" type="date" class="form-control" id="startDate" aria-describedby="emailHelp">
          </div>
          <div class="mb-3">
...
export default {
  setup() {
    ...
    async createEvent(){
      const userInfo = editable.value
      await towerEventsService.createEvent(userInfo)
      editable.value = {}
